...
use UglyRobot\Infinite_Uploads\GuzzleHttp\Cookie\CookieJarInterface;
...
use UglyRobot\Infinite_Uploads\Psr\Log\LoggerInterface;
/**
...
final class Middleware
{
    ...
    public static function httpErrors()
    {
        return function (callable $handler) {
            return function ($request, array $options) use($handler) {
                ...
                return $handler($request, $options)->then(function (\UglyRobot\Infinite_Uploads\Psr\Http\Message\ResponseInterface $response) use($request) {
                    $code = $response->getStatusCode();
                    if ($code < 400) {
                        return $response;
                    }
                    throw \UglyRobot\Infinite_Uploads\GuzzleHttp\Exception\RequestException::create($request, $response);
                });
            };
        };
    }
    ...
    {
        return function (callable $handler) {
            return new \UglyRobot\Infinite_Uploads\GuzzleHttp\RedirectMiddleware($handler);
        };
    }
    /**
    ...
    public static function retry(callable $decider, callable $delay = null)
    {
        return function (callable $handler) use($decider, $delay) {
            return new \UglyRobot\Infinite_Uploads\GuzzleHttp\RetryMiddleware($decider, $handler, $delay);
        };
    }
    /**
     ...
     * @return callable Returns a function that accepts the next handler.
     */
    public static function log(\UglyRobot\Infinite_Uploads\Psr\Log\LoggerInterface $logger, \UglyRobot\Infinite_Uploads\GuzzleHttp\MessageFormatter $formatter, $logLevel = 'info')
    {
    ...
    {
        return function (callable $handler) {
            return new \UglyRobot\Infinite_Uploads\GuzzleHttp\PrepareBodyMiddleware($handler);
        };
    }
    /**
