...
class CurlHandler
{
    ...
    {
        $this->factory = isset($options['handle_factory']) ? $options['handle_factory'] : new \UglyRobot\Infinite_Uploads\GuzzleHttp\Handler\CurlFactory(3);
    }
    public function __invoke(\UglyRobot\Infinite_Uploads\Psr\Http\Message\RequestInterface $request, array $options)
    {
        ...
        return \UglyRobot\Infinite_Uploads\GuzzleHttp\Handler\CurlFactory::finish($this, $easy, $this->factory);
    }
}
