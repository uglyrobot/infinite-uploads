...
class HandlerStack
{
    ...
    public static function create(callable $handler = null)
    {
        ...
        $stack->push(\UglyRobot\Infinite_Uploads\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\UglyRobot\Infinite_Uploads\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\UglyRobot\Infinite_Uploads\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\UglyRobot\Infinite_Uploads\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
