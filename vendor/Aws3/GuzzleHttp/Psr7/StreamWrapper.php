...
class StreamWrapper
{
     ...
     */
    public static function getResource(\UglyRobot\Infinite_Uploads\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\UglyRobot\Infinite_Uploads\Psr\Http\Message\StreamInterface $stream)
    {
