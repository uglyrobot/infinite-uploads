 ...
 */
class PumpStream implements \UglyRobot\Infinite_Uploads\Psr\Http\Message\StreamInterface
{
    /** @var callable */
    private $source;
    /** @var int */
    ...
    public function __construct(callable $source, array $options = [])
    {
        ...
        $this->buffer = new \UglyRobot\Infinite_Uploads\GuzzleHttp\Psr7\BufferStream();
    }
