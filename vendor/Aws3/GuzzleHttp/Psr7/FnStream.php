 ...
 */
class FnStream implements \UglyRobot\Infinite_Uploads\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\UglyRobot\Infinite_Uploads\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
