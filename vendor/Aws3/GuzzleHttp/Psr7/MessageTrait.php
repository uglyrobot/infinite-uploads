...
trait MessageTrait
{
    ...
    {
        if (!$this->stream) {
            $this->stream = \UglyRobot\Infinite_Uploads\GuzzleHttp\Psr7\Utils::streamFor('');
        }
        return $this->stream;
    }
    public function withBody(\UglyRobot\Infinite_Uploads\Psr\Http\Message\StreamInterface $body)
    {
        if ($body === $this->stream) {
            return $this;
        }
