...
class Sdk
{
    ...
    public function createClient($name, array $args = [])
    {
        ...
        $client = "UglyRobot\\Infinite_Uploads\\Aws\\{$namespace}\\{$namespace}Client";
    ...
    public function createMultiRegionClient($name, array $args = [])
    {
        ...
        $service = manifest($name);
        $namespace = $service['namespace'];
        $klass = "UglyRobot\\Infinite_Uploads\\Aws\\{$namespace}\\{$namespace}MultiRegionClient";
        $klass = class_exists($klass) ? $klass : 'UglyRobot\\Infinite_Uploads\\Aws\\MultiRegionClient';
