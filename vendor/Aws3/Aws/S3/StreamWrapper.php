...
class StreamWrapper
{
     ...
     */
    public static function register(\UglyRobot\Infinite_Uploads\Aws\S3\S3ClientInterface $client, $protocol = 's3', \UglyRobot\Infinite_Uploads\Aws\CacheInterface $cache = null)
    {
        ...
        if ($cache) {
            ...
            $default[$protocol]['cache'] = new \UglyRobot\Infinite_Uploads\Aws\LruArrayCache();
        }
