...
class PostObject
{
     ...
     *                                      behalf.
     */
    public function __construct(\UglyRobot\Infinite_Uploads\Aws\S3\S3ClientInterface $client, $bucket, array $formInputs, $jsonPolicy)
    {
        $this->client = $client;
        $this->bucket = $bucket;
    ...
    protected function getPolicyAndSignature(\UglyRobot\Infinite_Uploads\Aws\Credentials\CredentialsInterface $creds)
    {
