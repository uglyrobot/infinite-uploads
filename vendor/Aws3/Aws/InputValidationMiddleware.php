...
class InputValidationMiddleware
{
     ...
     * @return callable     */
    public static function wrap(\UglyRobot\Infinite_Uploads\Aws\Api\Service $service, $mandatoryAttributeList)
    {
    ...
    public function __construct(callable $nextHandler, \UglyRobot\Infinite_Uploads\Aws\Api\Service $service, $mandatoryAttributeList)
    {
        $this->service = $service;
        $this->nextHandler = $nextHandler;
        $this->mandatoryAttributeList = $mandatoryAttributeList;
    }
    public function __invoke(\UglyRobot\Infinite_Uploads\Aws\CommandInterface $cmd)
    {
