...
class ByteArray extends \SplFixedArray
{
    ...
    {
        return new \UglyRobot\Infinite_Uploads\Aws\Crypto\Polyfill\ByteArray(\pack('N', $num));
    }
    /**
     * @param ByteArray $other
     * @return bool
     */
    public function equals(\UglyRobot\Infinite_Uploads\Aws\Crypto\Polyfill\ByteArray $other)
    {
     ...
     * @return ByteArray
     */
    public function exclusiveOr(\UglyRobot\Infinite_Uploads\Aws\Crypto\Polyfill\ByteArray $array)
    {
     ...
     * @return ByteArray
     */
    public static function select($select, \UglyRobot\Infinite_Uploads\Aws\Crypto\Polyfill\ByteArray $left, \UglyRobot\Infinite_Uploads\Aws\Crypto\Polyfill\ByteArray $right)
    {
     ...
     * @return self
     */
    public function set(\UglyRobot\Infinite_Uploads\Aws\Crypto\Polyfill\ByteArray $input, $offset = 0, $length = null)
    {
    ...
    {
        return new \UglyRobot\Infinite_Uploads\Aws\Crypto\Polyfill\ByteArray(\array_slice($this->toArray(), $start, $length));
    }
    /**
