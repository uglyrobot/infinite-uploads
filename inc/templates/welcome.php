	...
	<div class="card-body cloud p-5">
		<div class="row justify-content-center mb-5 mt-3">
			<div class="col text-center">
				...
				<p class="lead"><?php esc_html_e( "Welcome to Infinite Uploads, scalable cloud storage and delivery for your uploads made easy! Get started with a scan of your existing Media Library for smart recommendations choosing the best plan for your site, create or connect your account, and voilà – you're ready to push to the cloud.", 'infinite-uploads' ); ?></p>
			</div>
		</div>
		<div class="row justify-content-center mb-5">
			<div class="col-2 text-center">
				<button class="btn text-nowrap btn-primary btn-lg btn-block" data-toggle="modal" data-target="#scan-modal"><?php esc_html_e( 'Run Scan', 'infinite-uploads' ); ?></button>
			</div>
		</div>
