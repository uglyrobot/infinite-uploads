<div id="iup-footer" class="container mt-5">
	...
	<div class="row mt-3">
		<div class="col-sm text-center text-muted">
			<a href="<?php echo esc_url( $this->api_url( '/support/' ) ); ?>" class="text-muted"><?php esc_html_e( "Support", 'infinite-uploads' ); ?></a> |
			<a href="<?php echo esc_url( $this->api_url( '/terms-of-service/' ) ); ?>" class="text-muted"><?php esc_html_e( "Terms of Service", 'infinite-uploads' ); ?></a> |
			<a href="<?php echo esc_url( $this->api_url( '/privacy/' ) ); ?>" class="text-muted"><?php esc_html_e( "Privacy Policy", 'infinite-uploads' ); ?></a>
		</div>
	</div>
	<div class="row mt-3">
		<div class="col-sm text-center text-muted">
