	...
	<div class="card-body cloud p-5">
		...
		<div class="row justify-content-center mb-1">
			<div class="col-4 text-center">
				...
				<a class="btn text-nowrap btn-info btn-lg" id="" href="<?php echo esc_url( $this->api_url( '/account/' ) ); ?>" role="button"><?php esc_html_e( 'Account Management', 'infinite-uploads' ); ?></a>
			</div>
		</div>
	</div>
</div>
