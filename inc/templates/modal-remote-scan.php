				...
				<div class="container-fluid">
					...
					<div class="row justify-content-center mb-5">
						<div class="col text-center text-muted">
							<span class="h3"><?php printf( __( '<span id="iup-scan-remote-storage">%s</span> / <span id="iup-scan-remote-files">%s</span> Files Synced', 'infinite-uploads' ), $stats['cloud_size'], $stats['cloud_files'] ); ?></span>
						</div>
					</div>
