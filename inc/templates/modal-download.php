					...
					<div class="row justify-content-center mb-5">
						<div class="col text-center">
							...
							<div class="col text-center text-muted">
								...
								<span
									class="h6" <?php echo ! $stats['deleted_files'] ? 'id="iup-download-progress"' : ''; ?>><?php printf( __( '<span id="iup-download-size">%s</span> / <span id="iup-download-files">%s</span> Files Remaining', 'infinite-uploads' ), $stats['deleted_size'], $stats['deleted_files'] ); ?></span>
							</div>
						</div>
					</div>
				</div>
